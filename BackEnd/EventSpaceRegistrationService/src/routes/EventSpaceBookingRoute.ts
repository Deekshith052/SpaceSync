...
import { createBooking, getBookings, updateBooking, deleteBooking, getBookingById, getEventSpacesByDate, createMultipleBookings, getBookingsByUserId, getTotalReservationsByDate } from '../controller/EventSpaceBookingController';
...
router.get("/eventspacebookingsNumber",getTotalReservationsByDate);
